...
const { Serverless, ServerlessBundlerPlugin } = require("@11ty/eleventy");
...
module.exports = function(eleventyConfig) {
	...
	eleventyConfig.setBrowserSyncConfig({
		middleware: async (req, res, next) => {
			let serverlessFunction = require("./netlify/functions/serverless/index");
			let eleventy = serverlessFunction.getEleventy(req.url, {
				// This is generated by `serverless-collections-export.11ty.js`
				precompiledCollections: require("./_generated-serverless-collections.json")
			});

			if(eleventy.isServerlessUrl(req.url)) {
				let start = new Date();
				res.writeHead(200, {
					"Content-Type": "text/html; charset=UTF-8"
				});
				res.write(await eleventy.render());
				res.end();
	...
	eleventyConfig.addPlugin(ServerlessBundlerPlugin, {
		name: "serverless",
