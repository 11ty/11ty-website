...
While it can be confusing for beginners learn it, Eleventy’s [Pagination feature](/docs/pagination/) is used for iterating over any data to create multiple output files.
