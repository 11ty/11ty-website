...
Controls which directory is the _includes_ directory. The _includes_ directory is meant for templates, extends, partials or other includes like macros and images.
