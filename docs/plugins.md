...
* [eleventy-plugin-cloudinary](https://www.npmjs.com/package/eleventy-plugin-cloudinary) by [Juan Fernandes](https://www.juanfernandes.uk/) adds a universal shortcode so you to add an images from your cloudinary account.
