...
* [Deploying an 11ty Site to Azure Static Web Apps - Getting started](https://github.com/manekinekko/11ty-blog-swa) by {% avatarlocalcache "twitter", "manekinekko" %} Wassim Chegham
