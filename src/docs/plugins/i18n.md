...
Note that this plugin specifically helps you manage links between content but does _not_ localize that content’s strings, numbers, dates, etc.  You’ll likely want to pick a third-party library for this! A few popular choices include [`rosetta`](https://github.com/lukeed/rosetta), [`i18next`](https://www.npmjs.com/package/i18next), [`y18n`](https://www.npmjs.com/package/y18n), [`intl-messageformat`](https://www.npmjs.com/package/intl-messageformat), and [LinguiJS](https://lingui.js.org/tutorials/javascript.html).
