...
Note that Eleventy works with a variety of third-party JavaScript libraries for organizing and localizing strings, numbers, dates, etc.  A few popular choices include [`rosetta`](https://github.com/lukeed/rosetta), [`i18next`](https://www.npmjs.com/package/i18next), [`y18n`](https://www.npmjs.com/package/y18n), [`intl-messageformat`](https://www.npmjs.com/package/intl-messageformat), and [LinguiJS](https://lingui.js.org/tutorials/javascript.html).
